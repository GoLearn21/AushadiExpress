...
Files reviewed: `.scratch/rally-phase1/spec.md`, `docs/usecases/USE-CASE-CATALOG.md`, `docs/decisions/adr/ADR-INDEX.md` (001–034), `docs/architecture/TECHNICAL-ARCHITECTURE.md`, `docs/design/DESIGN-PHILOSOPHY.md`, `docs/CONTEXT.md`, plus `research/17-vercel-supabase-limits.md` and PRD §5/§7/§8.4/§9.
